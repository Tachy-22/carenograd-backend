-- Supabase Schema Fix for Multi-User RAG System
...
-- Step 2: Create documents table with user isolation (NO RLS for service key)
...
-- Step 3: Create document_chunks table with user isolation (NO RLS for service key)
...
-- Check existing data for your user
SELECT 
  d.id as document_id,
  d.original_name,
  d.upload_status,
...
WHERE d.user_id = '8b276f6f-ac2d-43db-a776-ce976629d3f1'
GROUP BY d.id, d.original_name, d.upload_status;
